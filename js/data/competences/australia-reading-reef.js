    ...
    courses: [
      {
        ...
        items: [
          { de: "In Australien ist **Weihnachten** im Sommer.", en: "In Australia, ___ is in summer.", answer: "Christmas" },
          { de: "Ich habe morgen eine **Prüfung** in Englisch.", en: "I have an English ___ tomorrow.", answer: "exam" },
          { de: "Australien hat ein warmes **Klima**.", en: "Australia has a warm ___.", answer: "climate" },
          { de: "Wir haben **endlich** den Gipfel erreicht.", en: "We ___ reached the top.", answer: "finally" },
          { de: "Die **australischen Ureinwohner** haben eine lange Geschichte.", en: "___ Australians have a long history.", answer: "Aboriginal" },
          { de: "Ich **bekomme Durst** in der Sonne.", en: "I get ___ in the sun.", answer: "thirsty" },
          { de: "Ich lese, **während** du kochst.", en: "I read ___ you cook.", answer: "while" },
          { de: "Kannst du mir einen **Rat** geben?", en: "Can you give me some ___?", answer: "advice" },
          { de: "Wenige Menschen leben im **Hinterland Australiens**.", en: "Few people live in the ___.", answer: "outback", accept: ["the outback"] },
          { de: "Er **leidet an** Kopfschmerzen.", en: "He ___ from headaches.", answer: "suffers", accept: ["suffer"] },
          { de: "Der Sommer ist meine liebste **Jahreszeit**.", en: "Summer is my favourite ___.", answer: "season" },
          { de: "Wir waren auf einem **Campingplatz** am See.", en: "We stayed at a ___ by the lake.", answer: "campground" },
          { de: "Sie arbeitet für eine hilfreiche **Organisation**.", en: "She works for a helpful ___.", answer: "organization", accept: ["organisation"] },
          { de: "Wir haben gespielt, **obwohl** es geregnet hat.", en: "We played ___ it rained.", answer: "although" },
          { de: "Das ist eine berühmte historische **Stätte**.", en: "This is a famous historic ___.", answer: "site" },
        ],
      },
      {
        key: "ekurs",
        ...
        items: [
          ...
          { de: "**Einer von fünf** Schülern geht zu Fuß zur Schule.", en: "___ students walks to school.", answer: "one in five" },
          { de: "Ein **Hai** schwimmt im Meer.", en: "A ___ swims in the sea.", answer: "shark" },
          { de: "**Laut** der Karte sind wir hier.", en: "___ the map, we are here.", answer: "according to" },
          { de: "Regen ist heute **wahrscheinlich**.", en: "Rain is ___ today.", answer: "likely" },
          { de: "Das Land hier ist sehr **flach**.", en: "The land here is very ___.", answer: "flat" },
          { de: "Haie greifen selten **Menschen** an.", en: "Sharks rarely attack ___.", answer: "humans", accept: ["human"] },
          { de: "Wenige Menschen leben im **Hinterland Australiens**.", en: "Few people live in the ___.", answer: "outback", accept: ["the outback"] },
          { de: "Das Känguru ist Australiens **bekanntestes** Tier.", en: "The kangaroo is Australia's ___ animal.", answer: "best-known" },
          { de: "Sie ist eine **Bürgerin** Australiens.", en: "She is a ___ of Australia.", answer: "citizen" },
          { de: "Hier gibt es ein **Verbot**, zu schwimmen.", en: "There is a ___ on swimming here.", answer: "ban" },
          { de: "Ich mag **Honig** auf meinem Brot.", en: "I like ___ on my bread.", answer: "honey" },
          { de: "Eine **Qualle** schwebt im Wasser.", en: "A ___ floats in the water.", answer: "jellyfish" },
          { de: "Eine **Spinne** sitzt in ihrem Netz.", en: "A ___ sits in its web.", answer: "spider" },
          { de: "Australien hat **vielfältige** Tiere.", en: "Australia has ___ animals.", answer: "diverse" },
        ],
      },
    ],
  },
      ...
      cards: [
        {
          ...
          help: "Tip: a comic is fast — a few words per bubble is perfect (max 10). Try to use this unit's words: outback, vehicle, shade, sting, citizen …",
        },
      ],
    },
  ],
