...
export default {
  ...
  newWords: {
    ...
    stampLabel: "OUTBACK",
    words: [
      { en: "the outback", de: "das Hinterland Australiens", ex: "The outback covers most of Australia, yet almost no one lives there." },
      { en: "human", de: "der Mensch", ex: "In the vast outback, you can drive for hours without seeing another human." },
      { en: "to break down", de: "eine Panne haben", ex: "If your car breaks down in the desert, staying with the vehicle is much safer than walking." },
      { en: "vehicle", de: "das Fahrzeug", ex: "Rangers found the empty vehicle, but the driver had already walked off into the heat." },
      { en: "shade", de: "der Schatten", ex: "With temperatures above 45°C, finding shade can be the difference between life and death." },
      { en: "torch", de: "die Taschenlampe", ex: "At night she signalled the rescue plane with a torch." },
      { en: "nickname", de: "der Spitzname", ex: "The Royal Flying Doctor Service soon earned the nickname 'the Flying Doctors'." },
      { en: "citizen", de: "der Bürger / die Bürgerin", ex: "The Flying Doctors treat every citizen for free, no matter how remote their home." },
      { en: "road trip", de: "die Autoreise", ex: "Every year tourists set off on a road trip across the outback, often underestimating the distances." },
      { en: "according to", de: "laut / gemäß", ex: "According to the service, its planes fly far enough each year to reach the moon and back." },
      { en: "jellyfish", de: "die Qualle", ex: "During the wet season, deadly box jellyfish drift close to the northern beaches." },
      { en: "to sting", de: "stechen", ex: "A single sting from a box jellyfish can stop a swimmer's heart within minutes." },
      { en: "shark", de: "der Hai", ex: "A surfer bitten by a shark was flown to hospital in under an hour." },
      { en: "ban (on)", de: "das Verbot (von)", ex: "During stinger season there is a ban on swimming at many unprotected beaches." },
      { en: "honey", de: "der Honig", ex: "A beekeeper collecting honey was stung so badly that the Flying Doctors had to fly out to him." },
    ],
  },
