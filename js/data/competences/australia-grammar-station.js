...
export default {
  ...
  guide: {
    ...
    subtitle: "Reference for the whole page — can · must · be able to, and the 4 tenses",
    numbered: false,
    types: [
      {
        n: 1,
        ...
        example: "I can surf. → I could surf.",
      },
      {
        n: 2,
        name: "must / have to",
      ...
      },
      {
        ...
        example: "I am able to swim. → I was able to swim.",
      },
    ],
    tensesLabel: "The 4 tenses — quick revision",
    tenses: [
      { tense: "Simple Present", use: "habits, facts and rules", signals: "every day, usually, often, always" },
      { tense: "Simple Past", use: "finished actions; a chain of events", signals: "yesterday, last week, ago, in 2020" },
      { tense: "Present Perfect", use: "a past action with a result NOW", signals: "just, already, ever, yet, since, for" },
      { tense: "Past Progressive", use: "a longer background action in the past", signals: "while, when, at 9 a.m. yesterday" },
    ],
  },
