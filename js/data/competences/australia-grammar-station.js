      ...
      cards: [
        {
          ...
          highlight: {
            ...
            // Verb forms in text order, each with its tense — used by Check.
            answers: [
              { word: "lives", tense: "present" },
              { word: "must", tense: "present" },
              { word: "can", tense: "present" },
              { word: "is", tense: "present" },
              { word: "has", tense: "perfect" },
              { word: "finished", tense: "perfect" },
              { word: "can", tense: "present" },
              { word: "can", tense: "present" },
              { word: "can't", tense: "present" },
              { word: "must", tense: "present" },
              { word: "wanted", tense: "past" },
              { word: "couldn't", tense: "past" },
              { word: "were", tense: "past" },
              { word: "had", tense: "past" },
              { word: "were", tense: "progressive" },
              { word: "waiting", tense: "progressive" },
              { word: "played", tense: "past" },
              { word: "was", tense: "past" },
              { word: "was", tense: "past" },
              { word: "was", tense: "past" },
            ],
        ...
        },
        {
          ...
          lines: [
            ...
            { speaker: "2.", segments: ["Today is Saturday. → ", { gap: 1 }] },
            { speaker: "3.", segments: ["The waves were too big. → ", { gap: 2 }] },
            { speaker: "4.", segments: ["They played beach volleyball. → ", { gap: 3 }] },
            { speaker: "5.", segments: ["Yesterday the friends wanted to surf. → ", { gap: 4 }] },
          ],
          gaps: [
            { options: ["Simple Present", "Simple Past"], answer: "Simple Present" },
            { options: ["Simple Present", "Simple Past"], answer: "Simple Present" },
            { options: ["Simple Present", "Simple Past"], answer: "Simple Past" },
            { options: ["Simple Present", "Simple Past"], answer: "Simple Past" },
            { options: ["Simple Present", "Simple Past"], answer: "Simple Past" },
          ],
        },
      ...
      cards: [
        {
          ...
          intro:
            "Your project: design the eight rule signs for an outback campsite. Write one rule on each sign — and every rule must use the modal shown below it. Watch each sign come to life as you type.",
          signs: [
            { hint: "Sign 1 — use must", placeholder: "You must carry two litres of water." },
            { hint: "Sign 2 — use must not / can't", placeholder: "You must not feed the dingoes." },
            { hint: "Sign 3 — use should", placeholder: "You should stay on the marked path." },
            { hint: "Sign 4 — use shouldn't", placeholder: "You shouldn't leave food in your tent." },
            { hint: "Sign 5 — use have to", placeholder: "You have to check in at the ranger's hut." },
            { hint: "Sign 6 — use don't have to", placeholder: "You don't have to bring firewood — we sell it." },
            { hint: "Sign 7 — use may / are allowed to", placeholder: "You may swim before sunset." },
            { hint: "Sign 8 — your own rule (any modal)", placeholder: "You can watch the stars from the lookout." },
          ],
          help: "Tip: every sign needs its modal (must, must not, should, shouldn't, have to, don't have to, may, can). Keep it short — signs are read from far away.",
        },
      ],
    },
  ],
