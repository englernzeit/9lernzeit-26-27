...
export default {
  ...
  newWords: {
    ...
    stampLabel: "ON AIR",
    words: [
      { en: "to target sb.", de: "jn. ins Visier nehmen / als Zielgruppe wählen", ex: "Advertisers deliberately target teenagers, because they spend so much time online." },
      { en: "savvy", de: "versiert, gewieft, erfahren", ex: "Most teens are pretty savvy and can spot a fake review instantly." },
      { en: "to fit in", de: "dazugehören / hineinpassen", ex: "Ads promise that their trainers will help you fit in with the cool crowd." },
      { en: "billboard", de: "die Plakatwand / das Werbeplakat", ex: "A huge billboard by the motorway showed the new phone in giant letters." },
      { en: "to reduce (by)", de: "reduzieren / verringern (um)", ex: "The shop reduced the price by thirty percent to make us buy more." },
      { en: "advertiser", de: "der/die Werbetreibende", ex: "Advertisers know exactly which emotions make us reach for our wallets." },
      { en: "to design", de: "entwerfen, gestalten, entwickeln", ex: "Companies design their ads to make you feel that something is missing from your life." },
      { en: "unnatural", de: "unnatürlich", ex: "In the shampoo ad the model's hair looked almost unnatural, it was so perfect." },
      { en: "to repeat", de: "wiederholen", ex: "The same slogan is repeated again and again until you simply can't forget it." },
      { en: "sample", de: "das Muster / die Probe", ex: "They handed out free samples so that everyone would try the new drink." },
      { en: "advertising", de: "die Werbung / Reklame", ex: "Advertising is everywhere: on your phone, between videos and even inside games." },
      { en: "to irritate", de: "(ver)ärgern, irritieren", ex: "Pop-up ads that block the whole screen really irritate me." },
      { en: "to gatecrash (a party)", de: "(bei einer Party) ungebeten erscheinen", ex: "Online ads gatecrash your feed like an uninvited guest at a party." },
      { en: "to reach (sb./a place)", de: "(jn./einen Ort) erreichen", ex: "A single viral clip can reach millions of people in just a few hours." },
      { en: "damage (to)", de: "der Schaden / die Schäden (an)", ex: "Constant adverts can do real damage to how young people see themselves." },
    ],
  },
  ...
  wordMaster: {
    ...
    items: [
      { de: "**Werbung** ist überall: auf dem Handy, zwischen Videos, sogar in Spielen.", en: "___ is everywhere: on your phone, between videos, even in games.", answer: "advertising" },
      { de: "Eine riesige **Plakatwand** an der Autobahn zeigte das neue Handy.", en: "A huge ___ by the motorway showed the new phone.", answer: "billboard" },
      { de: "Werber **nehmen** gezielt Jugendliche **ins Visier**.", en: "Advertisers deliberately ___ teenagers.", answer: "target" },
      { de: "Ein einziger viraler Clip kann Millionen **erreichen**.", en: "A single viral clip can ___ millions of people.", answer: "reach" },
      { de: "Die Haare des Models sahen fast **unnatürlich** perfekt aus.", en: "The model's hair looked almost ___, it was so perfect.", answer: "unnatural" },
      { de: "Der Laden **senkte** den Preis um dreißig Prozent.", en: "The shop ___d the price by thirty percent.", answer: "reduce" },
      { de: "Pop-up-Anzeigen, die den ganzen Bildschirm blockieren, **ärgern** mich sehr.", en: "Pop-up ads that block the whole screen really ___ me.", answer: "irritate" },
      { de: "Die meisten Teenager sind ziemlich **gewieft** und erkennen Fake-Bewertungen sofort.", en: "Most teens are pretty ___ and spot fake reviews instantly.", answer: "savvy" },
      { de: "Sie verteilten kostenlose **Proben**, damit jeder das Getränk probiert.", en: "They gave out free ___ so everyone would try the drink.", answer: "samples", accept: ["sample"] },
      { de: "**Werbetreibende** wissen genau, welche Gefühle uns zum Kaufen bringen.", en: "___ know exactly which emotions make us buy.", answer: "advertisers", accept: ["advertiser"] },
      { de: "Die Anzeige verspricht, dass du mit diesen Schuhen **dazugehörst**.", en: "The ad promises that these shoes will help you ___.", answer: "fit in" },
      { de: "Ständige Werbung kann echten **Schaden** anrichten, wie Jugendliche sich sehen.", en: "Constant adverts can do real ___ to how young people see themselves.", answer: "damage" },
      { de: "Derselbe Slogan wird immer wieder **wiederholt**.", en: "The same slogan is ___ again and again.", answer: "repeated", accept: ["repeat"] },
      { de: "Firmen **gestalten** ihre Anzeigen so, dass dir etwas zu fehlen scheint.", en: "Companies ___ their ads so that you feel something is missing.", answer: "design" },
      { de: "Online-Anzeigen **erscheinen ungebeten** in deinem Feed wie ein Partygast.", en: "Online ads ___ your feed like an uninvited party guest.", answer: "gatecrash" },
    ],
  },
