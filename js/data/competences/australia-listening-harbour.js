      ...
      cards: [
        ...
        },
        {
          ...
          pairs: [
            ...
            { left: "liveable", right: "Comfortable and pleasant to live in" },
            { left: "trade", right: "Buying and selling goods" },
            { left: "gather", right: "Come together in one place" },
            { left: "wide", right: "The opposite of narrow" },
            { left: "suffer", right: "To feel pain or hardship" },
            { left: "neither", right: "Not the one and not the other" },
          ],
        },
        {
          type: "multiple-choice",
      ...
      cards: [
        {
          ...
          intro:
            "A new caller, Ruby, is on air. Below is the station's transcript of what she says — but the sound engineer made eight mistakes: eight words are different from the audio. Listen closely, tap each wrong word and type what Ruby really says, then press Check.",
          audio: { src: `${AUD}/au-detective.mp3`, label: "Radio phone-in · Ruby" },
          hint: "Play the clip as often as you like. Exactly eight words in the transcript are wrong.",
          paragraphs: [
            "Hi everyone, my name's Ruby and I've just turned sixteen. I live in a small coastal town near Sydney, in Western Australia, and the beach is only a short walk from my house.",
            "On weekdays I get up early and catch the bus to school, but at the weekend I'm always outside. After lunch I usually practise the piano for about an hour, and on Saturdays I take part in swimming competitions along the coast.",
            "My biggest dream is to study marine chemistry at university, because I've been fascinated by the river ever since I was a little kid. Honestly, I don't think Australian teenagers are that different from teenagers in America — we listen to the same music and worry about the same exams. The main difference is probably that we spend far more of our free time outdoors in the rain.",
          ],
          fixes: [
            ...
            { wrong: "chemistry", correct: "biology" },
            { wrong: "river", correct: "ocean" },
            { wrong: "America", correct: "Europe" },
            { wrong: "rain", correct: "sun" },
          ],
          help: "Tip: the wrong words are all facts and details — her age, her town, her instrument, her sport, her dream subject, what she loves, the place she compares Australia to, and the weather she means.",
        },
      ],
    },
  ],
