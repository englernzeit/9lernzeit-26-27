    ...
    /* ============ STEP 1 — LE ============ */
    {
      ...
      cards: [
        ...
        },
        {
          ...
          intro:
            "Write to the Blue Gum Koala Park in Brisbane. Fill in every part on the right — your email builds itself in the live preview. Question ideas: the price? · opening hours (Öffnungszeiten)? · feeding time? · photos with a koala?",
          to: "info@bluegum-koalapark.com.au",
          help: "Fill all six parts (incl. your full name) to send. Kurze, korrekte Sätze sind perfekt!",
        },
      ],
    },
