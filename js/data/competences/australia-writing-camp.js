...
export default {
  ...
  steps: [
    ...
    {
      step: 4,
      subtitle: "Challenge · Write the reply",
      accent: "ochre",
      layout: "single",
      cards: [
        {
          ...
          chips: [
            ...
            { n: "02", label: "Answer: age & tasks" },
            { n: "03", label: "Answer: accommodation" },
            { n: "04", label: "The next step (how to apply)" },
            { n: "05", label: "Formal closing" },
          ],
          min: 100,
          max: 140,
          placeholder: "Write your email here…",
          checklist: [
            "I began 'Dear …' and thanked them for their email.",
            "I answered the question about age and tasks.",
            "I answered the question about accommodation.",
            "I told them clearly how to apply / what happens next.",
            "I used formal phrases (We are pleased to …, Please find …).",
            "I closed formally and signed for the organisation.",
          ],
          help: "Tip: start 'Dear …, Thank you for your email about …'. Answer one question per line, then give the next step.",
        },
      ],
    },
  ],
