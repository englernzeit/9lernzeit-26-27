      ...
      cards: [
        {
          ...
          title: "Beat the Heat — one poster, two languages",
          intro:
            "You are the designer for an Australian park that wants EVERYONE to stay safe in the sun — both English- and German-speaking visitors. So you must make the SAME poster twice: fill the left copy completely in English and the right copy completely in German. For each one write the headline, the rule under each of the five pictures, and the message in the banner. Same pictures, same meaning, two languages — that is mediation! Your words appear on each poster as you type.",
          base: "assets/images/unit1",
          img: "beat-the-heat.jpg",
          posters: [
            { lang: "en", label: "English poster" },
            { lang: "de", label: "Deutsches Poster" },
          ],
          zones: [
            { role: "title", pdf: "Headline", x: 7, y: 6, w: 41, h: 33 },
            { role: "caption", pdf: "Rule · water icon", x: 2, y: 68, w: 13, h: 6 },
            { role: "caption", pdf: "Rule · hat icon", x: 13.5, y: 68, w: 13, h: 6 },
            { role: "caption", pdf: "Rule · sunscreen icon", x: 25, y: 68, w: 12, h: 6 },
            { role: "caption", pdf: "Rule · shade icon", x: 37, y: 68, w: 12, h: 6 },
