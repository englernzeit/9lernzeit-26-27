      ...
      cards: [
        {
          ...
          intro:
            "This sun-safety poster is almost ready, but the words are missing. Finish it: 1) write a short, catchy HEADLINE in English in the top box; 2) under each of the five pictures, write the rule it shows (e.g. “Drink water”); 3) write the poster's main message in GERMAN in the banner at the bottom (mediation — say it in your own words). Your text appears on the poster as you type.",
          base: "assets/images/unit1",
          img: "beat-the-heat.jpg",
          zones: [
            { role: "title", lang: "en", label: "English headline", x: 7, y: 6, w: 41, h: 33 },
            { role: "caption", label: "", pdf: "Rule under the water icon", x: 2, y: 68, w: 13, h: 6 },
            { role: "caption", label: "", pdf: "Rule under the hat icon", x: 13.5, y: 68, w: 13, h: 6 },
            { role: "caption", label: "", pdf: "Rule under the sunscreen icon", x: 25, y: 68, w: 12, h: 6 },
            { role: "caption", label: "", pdf: "Rule under the tree/shade icon", x: 37, y: 68, w: 12, h: 6 },
            { role: "caption", label: "", pdf: "Rule under the clothing icon", x: 48, y: 68, w: 13, h: 6 },
            { role: "banner", lang: "de", label: "Deutsch · deine Botschaft", x: 4, y: 76, w: 47, h: 18 },
          ],
          help: "Tip: a good headline is short and punchy (like “Beat the Heat!”). Under the pictures use short rules (Drink water · Wear a hat · Use sunscreen · Seek shade · Light clothing). In the German banner, tell people in your own words why they should protect themselves from the sun.",
        },
      ],
    },
  ],
